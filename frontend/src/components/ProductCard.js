...
import { FiTruck, FiShield, FiGift, FiX, FiZap, FiTrendingUp, FiAward } from 'react-icons/fi';
          ...
          <div className="content">
            ...
            <div className="trust-bar" role="list" aria-label="شريط الثقة">
              <div className="trust-item" role="listitem" aria-label="أمان">
                <span className="trust-icon" aria-hidden="true"><FiShield /></span>
                <span className="trust-label">أمان</span>
              </div>
              <div className="trust-item" role="listitem" aria-label="سرعة">
                <span className="trust-icon" aria-hidden="true"><FiZap /></span>
                <span className="trust-label">سرعة</span>
              </div>
              <div className="trust-item" role="listitem" aria-label="ثقة">
                <span className="trust-icon-wrap" aria-hidden="true"><FiTrendingUp className="trust-icon trust-icon--invert" /></span>
